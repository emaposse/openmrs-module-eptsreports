...
public class ResumoMensalCetaSection1DataSet extends BaseDataSet {
  ...
  public CohortIndicatorDataSetDefinition constructDataSet() {
    ...
    addRow(
        dataSetDefinition,
        "RMCST6",
        "2a consulta TARV: Nr de Pacientes em seguimento no CETA ate o final do mes)",
    ...
    addRow(
        dataSetDefinition,
        "RMCST7",
        "2a consulta TARV: Nr de Pacientes com, pelo menos, uma Tentativa de Suicídio a entrada",
    ...
    addRow(
        dataSetDefinition,
        "RMCST9",
        "2a consulta TARV: Nr de pacientes com sintomas de ansiedade/depressão",
  ...
  private List<ColumnParameters> getColumnsSection6() {
    ...
    ColumnParameters twentyTo24F =
        new ColumnParameters(
            "twentyTo24M", "20 - 24 femele", "gender=F|age=20-24|state=second-consultation", "04");
    ...
    ColumnParameters twentyFivePlusF =
        new ColumnParameters(
            "fouty5To49M", "25+ femele", "gender=F|age=25+|state=second-consultation", "06");
