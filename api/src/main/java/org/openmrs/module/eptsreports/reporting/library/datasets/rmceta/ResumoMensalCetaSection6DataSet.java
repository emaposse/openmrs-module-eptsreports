...
public class ResumoMensalCetaSection6DataSet extends BaseDataSet {
  ...
  public CohortIndicatorDataSetDefinition constructDataSet() {
    ...
    dataSetDefinition.setName("Resumo Mensal CETA Secção 6");
    ...
    addRow(
        dataSetDefinition,
        "RMC0",
        "Total: Nr de Pacientes que reunem critérios para o rastreio FICA-BEM",
    ...
    addRow(
        dataSetDefinition,
        "RMC1",
        "Total: Nr de Pacientes rastreados usando o FICA-BEM",
    ...
    addRow(
        dataSetDefinition,
        "RMC2",
        "Total: Nr de Pacientes com resultado Positivo no FICA BEM",
    ...
    addRow(
        dataSetDefinition,
        "RMC3",
        "Total: Nr de Pacientes referidos para o seguimento de Doenca Mental Grave (psiquiatria/fluxo normal)",
  ...
  private List<ColumnParameters> getColumnsSection6() {
    ...
    ColumnParameters twentyTo24F =
        new ColumnParameters("twentyTo24M", "20 - 24 female", "gender=F|age=20-24", "04");
    ...
    ColumnParameters twentyFivePlusF =
        new ColumnParameters("fouty5To49M", "25+ female", "gender=F|age=25+", "06");

    ColumnParameters totalM =
        new ColumnParameters("totalM", "total male", "gender=M|age=15+", "07");

    ColumnParameters totalF =
        new ColumnParameters("totalF", "total female", "gender=F|age=15+", "08");
