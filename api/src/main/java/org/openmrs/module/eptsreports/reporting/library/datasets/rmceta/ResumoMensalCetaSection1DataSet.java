...
public class ResumoMensalCetaSection1DataSet extends BaseDataSet {
  ...
  private List<ColumnParameters> getColumnsSection6() {
    ...
    ColumnParameters twentyTo24F =
        new ColumnParameters(
            "twentyTo24M", "20 - 24 famele", "gender=F|age=20-24|state=second-consultation", "04");
    ...
    ColumnParameters twentyFivePlusF =
        new ColumnParameters(
            "fouty5To49M", "25+ famele", "gender=F|age=25+|state=second-consultation", "06");
    ...
    ColumnParameters totalF =
        new ColumnParameters("totalF", "total famele", "gender=F|state=second-consultation", "08");
