...
public class ResumoMensalCetaSection5DataSet extends BaseDataSet {
  ...
  public CohortIndicatorDataSetDefinition constructDataSet() {
    ...
    addRow(
        dataSetDefinition,
        "RMCSI4",
        "Sem Informacao: Nr de Pacientes com resultado positivo para Epilepsia",
    ...
    addRow(
        dataSetDefinition,
        "RMCSI7",
        "Sem Informacao: Nr de Pacientes em seguimento no CETA ate o final do mês",
    ...
    addRow(
        dataSetDefinition,
        "RMCSI8",
        "Sem Informacao: Nr de Pacientes com Ideação de Suicídio na entrada",
    ...
    addRow(
        dataSetDefinition,
        "RMCSI9",
        "Sem Informacao: Nr de Pacientes com Tentaiva de Suicídio na entrada",
    ...
    addRow(
        dataSetDefinition,
        "RMCSI10",
        "Sem Informacao: Nr de Pacientes com Ideação de Homicídio a entrada",
    ...
    addRow(
        dataSetDefinition,
        "RMCSI12",
        "Sem Informacao: Nr de pacientes com sintomas de depressão",
    ...
    addRow(
        dataSetDefinition,
        "RMCSI13",
        "Sem Informacao: Nr de pacientes com sintomas de ansiedadess",
