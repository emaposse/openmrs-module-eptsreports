...
public class ResumoMensalCetaSection3DataSet extends BaseDataSet {
  ...
  public CohortIndicatorDataSetDefinition constructDataSet() {
    ...
    addRow(
        dataSetDefinition,
        "RMCRM6",
        "Reintegrado/Ma Adesao: Nr de Pacientes em seguimento no CETA ate o final do mes)",
    ...
    addRow(
        dataSetDefinition,
        "RMCRM7",
        "Reintegrado/Ma Adesao: Nr de Pacientes com, pelo menos, uma Tentativa de Suicídio a entrada",
    ...
    addRow(
        dataSetDefinition,
        "RMCRM9",
        "Reintegrado/Ma Adesao: Nr de pacientes com sintomas de ansiedade/depressão",
  ...
  private List<ColumnParameters> getColumnsSection6() {
    ...
    ColumnParameters totalF =
        new ColumnParameters("totalF", "total femele", "gender=F|state=reintegreted", "08");
